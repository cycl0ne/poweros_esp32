...
//! OnGadget: lets a gadget be pressed again, and shows it so.
...
/// ```
pub fn OnGadget(ib: *IntuitionBase, gadget: *Object, window: *Window, requester: ?*Requester) void {
    _ = requester;
    setDisabled(ib, gadget, window, false);
}
